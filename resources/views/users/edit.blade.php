                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="title d-flex align-items-center flex-wrap mb-30">
                                <h2 class="mr-40">Editar usuário</h2>
                            </div>
                        </div>
                        <!-- end col -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30">
                            ...
                            <form method="POST" action="{{route('users.update', ['id' => $user->id])}}" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="form-check form-switch toggle-switch mb-30">
                                    <input class="form-check-input" type="checkbox" name="status" id="bloqued" {{ $user->bloqued == 0 ? 'checked' : ''}}>
                                        ...
                                        <div class="warning-alert">
                                            <div class="alert">
                                                ...
                                                <p class="text-sm text-gray">
                                                    Você esta prestes a inativar este usuário.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-style-1">
                                            ...
                                            <input type="text" name="name" placeholder="Nome completo" class="form-control bg-transparent" value="{{$user->name}}" required>
                                    ...
                                    <div class="col-12">
                                        <div class="input-style-1">
                                            ...
                                            <input type="text" name="username" placeholder="Nome usuário" class="form-control bg-transparent" pattern="^[A-Za-z0-9._]+$" value="{{$user->username}}" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <!-- end col -->
                                    <div class="col-12">
                                        <x-input-password class="bg-transparent" pattern=".{8,}" required />
                                    </div>
                                    <div class="col-12">
                                        <div class="select-style-1">
                                            ...
                                            <div class="select-position">
                                                <select name="group" class="form-control" required>
                                                    ...
                                                    <option value="1" {{$user->group == 1 ? 'selected' : ''}}>Operador</option>
                                                    <option value="2" {{$user->group == 2 ? 'selected' : ''}}>Administrador</option>
                                                </select>
                                                <div class="invalid-feedback">
